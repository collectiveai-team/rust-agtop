...
mod tests {
    ...
    fn known_clients_have_color() {
        ...
        assert_eq!(color_for(ClientKind::GeminiCli), Color::Rgb(0x42, 0x85, 0xF4));
        ...
        assert_eq!(color_for(ClientKind::Antigravity), Color::Rgb(0x22, 0xD3, 0xEE));
        assert_eq!(color_for(ClientKind::OpenCode), Color::Rgb(0xF4, 0x72, 0xB6));
    }
}
